...
public class FilePickerDialogFragment extends BaseNoFrameDialogFragment implements FilePickerView,
    ...
    private static FilePickerDialogFragment newInstance(Builder builder) {
        ...
        filePickerDialogFragment.onButtonsClickListener = builder.onButtonsClickListener;
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btnPlay) {
            onButtonsClickListener.playButtonClick();
        }
        if (id == R.id.btnList) {
            onButtonsClickListener.listButtonClick();
        }
        if (id == R.id.btnExit) {
            onButtonsClickListener.exitButtonClick();
        }
    }
...
//            loadFolder(fileAdapter.getItem(position).getAbsolutePath());
    ...
    @Override
    public void setupDialogPosition() {
...
//        getDialog().getWindow().setGravity(Gravity.CENTER);
    ...
    public static final class Builder {
        ...
        public Builder onButtonsClick(onButtonsClickListener onButtonsClickListener) {
